...
class AboutClassMethods < Neo::Koan
  ...
  #
  #I think I would prefer the first way, the term self for me is self explanitory, and less confusing than having
  # the word class appear twice in one class, makes it seem as if there are two distinct classes.
  # ------------------------------------------------------------------
